    ...
    <div className="flex flex-col h-full" onKeyDown={handleKeyDown}>
      ...
      <div className="flex items-center justify-between px-3 pt-3 pb-2 min-h-[42px]">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <button
            title="Save Request"
            onClick={() => saveRequest().then((r) => r?.success ? toast.success('Saved') : toast.error(r?.error || 'Failed'))}
            className="btn-ghost p-1.5 opacity-70 hover:opacity-100 hover:bg-[color:var(--surface-3)] transition-all rounded-md"
          >
